...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mar. 14 mars 2023 à 14:50
...
INSERT INTO `utilisateurs` (`id`, `login`, `password`, `droits`, `member_since`) VALUES
(1, 'Paul', '$2y$10$yD4q5zkZqjHKvQtYB5pMXu0D/yfTP2lEwENuFvxsi8iftPWvOiJtG', 'utilisateur', '2023-03-12 16:53:24'),
(2, 'admin', '$2y$10$s7ge/iAyamsG4AYKnmdm0.XYUrkHMuplRhmGUZICF12obh0Z/cFZK', 'administrateur', '2023-03-12 16:53:24'),
(4, 'lion', 'lion', 'moderateur', '2023-03-13 16:53:44'),
(6, 'Jules', '$2y$10$dIP.pggp2/Hd5X9ZkE3cGOZNKUk2l.UJL8elNyRRJYHaM3ZfFRsI2', 'administrateur', '2023-03-12 16:53:24'),
(7, 'Julia', '$2y$10$4AmB8NsoGMZ0Pfa8waw2pezWfAMq1MXqNhx1JWILz4k36NZnnuR1u', 'utilisateur', '2023-03-13 16:54:47');
COMMIT;
